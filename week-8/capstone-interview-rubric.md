...
2. **Code walkthrough** (about 3-4 min): selected files/functions, design choices, trade-offs.
3. **Q&A on code** (about 2-3 min): evaluator chooses areas; student explains to demonstrate understanding.
