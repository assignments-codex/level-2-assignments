**Goal:** Use `.map`, `.filter`, and `.reduce` to compute small summaries and render them.

## Steps

1. Fetch a dataset (any public API with an array of items).
2. Render a simple **list** of items.
